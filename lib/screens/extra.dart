...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Agar Firebase mein name set hai toh wo uthaye, warna 'User' dikhaye
  ...
  // SOS Alert Function with English Message
      ...
      SnackBar(
        content: Row(
          children: const [
            ...
            Expanded(
              child: Text(
                "Emergency alert sent to nearest ambulance and registered contacts!",
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Prominent SOS Button (Solid & Visible)
                  Center(
