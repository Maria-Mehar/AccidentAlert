...
// import 'package:firebase_auth/firebase_auth.dart'; // 👈 Ye boht zaroori hai
// import 'package:sensors_plus/sensors_plus.dart';
// // Agar User class par error hai to firebase_auth ka import lazmi hai
...
// void initState() {
//   super.initState();
//   _initializeUser(); // User initialize ho raha hai

//   // Sensor subscription yahan start ho rahi hai
//   _accelSubscription = accelerometerEvents.listen((AccelerometerEvent event) {
//     if (!alertTriggered && detectAccident(event)) {
//       alertTriggered = true;
//       Navigator.push(
...
=======
  String displayName = "User"; // Default value set kar di taake error na aaye
  StreamSubscription<AccelerometerEvent>? _accelSubscription;
  bool alertTriggered = false;
...
>>>>>>> Stashed changes
  ...
  bool detectAccident(AccelerometerEvent event) {
    ...
    return (totalAccel > 25 || totalAccel < 2);
  }
